 ...
 * which is why there is no table to type on this plugin's config page.
 *
...
export type PolarSource = 'resource' | 'none';
...
export interface ActivePolar {
  ...
  source: PolarSource;
  problems: string[];
  /** One line for the console and the log, e.g. "12 angles x 7 wind speeds". */
  summary: string;
}
 ...
 * one place by the plugin whose job that is.
 *
